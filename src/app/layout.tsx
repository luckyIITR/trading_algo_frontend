            ...
            <div className="min-h-screen flex">
              ...
              <aside className="hidden md:flex flex-col w-56 bg-white/90 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 shadow-lg py-6 px-4 gap-8">
                ...
                <nav className="flex flex-col gap-2 text-sm">
                  <Link href="/" className="px-3 py-2 rounded text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-gray-800 font-semibold transition">Dashboard</Link>
